...
def test_iter_decode():
    ...
    assert iter_decode_to_string([b'hello.txt'], 'latin1') == 'hello.txt'
    assert iter_decode_to_string([b'he', b'llo'], 'latin1') == 'hello.txt'
    assert iter_decode_to_string([b'hell', b'o'], 'latin1') == 'hello.txt'
