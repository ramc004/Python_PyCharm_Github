        ...
        if savedPassword is None:
            ...
            if password_db_log_in == savedPassword:
                ...
                if access_Level == "admin":
                        ...
                        try:
                            ...
                            with sr.Microphone() as source:
                                ...
                                if "weather" in speech:
                                    ...
                                    # a statement will be placed informing them to re try their command
                        except:
                    ...
                    # creates a variable for a button with text of voice assistant and a command
                    # linking to the function created above
                    voice_assistant_button.place(x=350, y=580)
                    # places the button on the corner of the window
            else:
