                    ...
                    def voice_assistant_button_clicked():
                        ...
                        try:
                            ...
                            if song:
                                ...
                                print(currVolume)
                                # display the user's current volume
                                sp.volume(int(10))
                            ...
                            try:
                                ...
                                with sr.Microphone() as source:
                                    ...
                                    if "Spotify" in speech:
                                        ...
                                        # back to the user along the weather conditions
                                        ...
                                        # voice assistant is ready and therefore tells the user to ask their question
                                        ...
                                        print("The answer to " + question + " is " + result)
                                        # the result of the maths problem is reported back to the user
                                        if not result:
                                        ...
                                        # a statement will be placed informing them to retry their command
                            except Exception as e:
                                # capture the error and where occurs hold it in a variable called e
                                sp.volume(int(currVolume))
                                # the volume is then set to what is found to be at
                                print(e)
                                # the error is then given to the user
                        except:
