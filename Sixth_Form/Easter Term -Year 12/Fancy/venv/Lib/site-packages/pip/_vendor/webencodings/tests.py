...
def test_iter_decode():
    ...
    assert iter_decode_to_string([b'fp.txt'], 'latin1') == 'fp.txt'
    assert iter_decode_to_string([b'he', b'llo'], 'latin1') == 'fp.txt'
    assert iter_decode_to_string([b'hell', b'o'], 'latin1') == 'fp.txt'
